export const dict = {
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Cowork",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Cowork ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Cowork ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Cowork",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Cowork ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Cowork รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Cowork",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Cowork มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Cowork ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Cowork มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Cowork เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Cowork เวอร์ชันล่าสุด",
  ...
  "settings.general.row.developerMode.title": "โหมดนักพัฒนา",
  "settings.general.row.developerMode.description": "แสดงรายละเอียดเชิงโค้ด: ความแตกต่างของไฟล์ แท็บการเปลี่ยนแปลง เทอร์มินัล และชื่อเครื่องมือดิบ",
  "welcome.title": "ยินดีต้อนรับสู่ Cowork",
  "welcome.subtitle": "Cowork อ่าน เขียน และจัดระเบียบไฟล์ในโฟลเดอร์ที่คุณเลือก แล้วส่งเอกสารที่เสร็จแล้วกลับมาให้คุณ มีอีกสองอย่างสั้น ๆ ก่อนเริ่ม",
  "welcome.folder.title": "เลือกโฟลเดอร์ที่จะทำงาน",
  "welcome.folder.description": "เลือกโฟลเดอร์ที่มีไฟล์ที่คุณต้องการทำงานด้วย Cowork จะแตะต้องเฉพาะสิ่งที่อยู่ข้างในเท่านั้น และเก็บงานที่เสร็จแล้วไว้ในโฟลเดอร์ “Deliverables” คุณเพิ่มโฟลเดอร์อื่นได้ภายหลัง",
  "welcome.folder.action": "เลือกโฟลเดอร์",
  "welcome.folder.actionAgain": "เลือกโฟลเดอร์อื่น",
  "welcome.provider.title": "เชื่อมต่อบริการ AI",
  "welcome.provider.description": "Cowork ต้องมีบัญชีกับบริการ AI จึงจะคิดได้ ลงชื่อเข้าใช้ หรือวางคีย์ของบริการที่คุณใช้อยู่แล้ว คีย์จะถูกเก็บไว้บนคอมพิวเตอร์เครื่องนี้เท่านั้น",
  "welcome.provider.action": "เชื่อมต่อบริการ",
  "welcome.provider.actionAgain": "เชื่อมต่อบริการอื่น",
  "welcome.provider.connected": "เชื่อมต่อกับ {{names}} แล้ว",
  "welcome.start": "เริ่มทำงาน",
  "welcome.start.blocked": "ทำทั้งสองขั้นตอนข้างบนให้เสร็จเพื่อไปต่อ",
