export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Coworkで{{provider}}モデルを使用します。",
  ...
  "dialog.server.description": "このアプリが接続するCoworkサーバーを切り替えます。",
  ...
  "toast.update.description": "Coworkの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCoworkチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CoworkはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Coworkには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Coworkの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCoworkの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Coworkがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Coworkのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Cowork の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Cowork は最新バージョンです。",
  ...
  "settings.general.row.developerMode.title": "開発者モード",
  "settings.general.row.developerMode.description": "コード向けの詳細を表示します: ファイルの差分、変更タブ、ターミナル、ツールの内部名",
  "welcome.title": "Cowork へようこそ",
  "welcome.subtitle": "Cowork は選んだフォルダの中のファイルを読み、書き、整理して、仕上がった書類をお返しします。始める前に 2 つだけ。",
  "welcome.folder.title": "作業するフォルダを選ぶ",
  "welcome.folder.description": "作業したいファイルが入っているフォルダを選んでください。Cowork はその中のものだけを扱い、仕上がったものはその中の「Deliverables」フォルダに入れます。フォルダは後から追加できます。",
  "welcome.folder.action": "フォルダを選ぶ",
  "welcome.folder.actionAgain": "別のフォルダを選ぶ",
  "welcome.provider.title": "AI サービスに接続する",
  "welcome.provider.description": "Cowork が考えるには AI サービスのアカウントが必要です。サインインするか、すでに使っているサービスのキーを貼り付けてください。キーはこのコンピュータにのみ保存されます。",
  "welcome.provider.action": "サービスに接続",
  "welcome.provider.actionAgain": "別のサービスに接続",
  "welcome.provider.connected": "{{names}} に接続済み",
  "welcome.start": "作業を始める",
  "welcome.start.blocked": "続けるには上の 2 つを完了してください",

  "dialog.provider.custom.label": "OpenAI 互換のカスタムプロバイダー",
  "dialog.model.unpaid.viewMoreProviders": "70 以上のプロバイダーを見る",
