...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Cowork zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Cowork-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Cowork ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Cowork-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Cowork unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Cowork enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Cowork ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Cowork auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Cowork dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Cowork anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Cowork automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Cowork.",
  ...
  "settings.general.row.developerMode.title": "Entwicklermodus",
  "settings.general.row.developerMode.description": "Code-orientierte Details anzeigen: Dateiunterschiede, den Änderungen-Tab, das Terminal und Rohnamen von Werkzeugen",
  "welcome.title": "Willkommen bei Cowork",
  "welcome.subtitle": "Cowork liest, schreibt und ordnet die Dateien in einem Ordner Ihrer Wahl und gibt Ihnen fertige Dokumente zurück. Zwei Dinge noch, bevor es losgeht.",
  "welcome.folder.title": "Wählen Sie einen Ordner zum Arbeiten",
  "welcome.folder.description": "Wählen Sie den Ordner mit den Dateien, an denen Sie arbeiten möchten. Cowork rührt nur an, was darin liegt, und legt Fertiges in einen Ordner „Deliverables“ ab. Weitere Ordner können Sie später hinzufügen.",
  "welcome.folder.action": "Ordner wählen",
  "welcome.folder.actionAgain": "Anderen Ordner wählen",
  "welcome.provider.title": "KI-Dienst verbinden",
  "welcome.provider.description": "Cowork braucht ein Konto bei einem KI-Dienst zum Denken. Melden Sie sich an oder fügen Sie einen Schlüssel des Dienstes ein, den Sie bereits nutzen. Er bleibt auf diesem Computer.",
  "welcome.provider.action": "Dienst verbinden",
  "welcome.provider.actionAgain": "Weiteren Dienst verbinden",
  "welcome.provider.connected": "Verbunden mit {{names}}",
  "welcome.start": "Loslegen",
  "welcome.start.blocked": "Schließen Sie beide Schritte oben ab, um fortzufahren",

  "dialog.provider.custom.label": "Eigener OpenAI-kompatibler Anbieter",
