...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Cowork.",
  ...
  "dialog.server.description": "Bytt hvilken Cowork-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Cowork ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Cowork-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Cowork ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Cowork inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Cowork",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Cowork ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Cowork skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Cowork er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Cowork starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Cowork.",
  ...
  "settings.general.row.developerMode.title": "Utviklermodus",
  "settings.general.row.developerMode.description": "Vis kodeorienterte detaljer: filforskjeller, endringsfanen, terminalen og rå verktøynavn",
  "welcome.title": "Velkommen til Cowork",
  "welcome.subtitle": "Cowork leser, skriver og organiserer filene i en mappe du velger, og gir deg ferdige dokumenter tilbake. To raske ting før du starter.",
  "welcome.folder.title": "Velg en mappe å jobbe i",
  "welcome.folder.description": "Velg mappen med filene du vil jobbe med. Cowork rører bare det som ligger i den, og legger det ferdige i en mappe som heter «Deliverables». Du kan legge til flere mapper senere.",
  "welcome.folder.action": "Velg en mappe",
  "welcome.folder.actionAgain": "Velg en annen mappe",
  "welcome.provider.title": "Koble til en KI-tjeneste",
  "welcome.provider.description": "Cowork trenger en konto hos en KI-tjeneste for å tenke. Logg inn, eller lim inn en nøkkel fra tjenesten du allerede betaler for. Den blir liggende på denne datamaskinen.",
  "welcome.provider.action": "Koble til en tjeneste",
  "welcome.provider.actionAgain": "Koble til en annen tjeneste",
  "welcome.provider.connected": "Koblet til {{names}}",
  "welcome.start": "Kom i gang",
  "welcome.start.blocked": "Fullfør begge stegene over for å fortsette",
