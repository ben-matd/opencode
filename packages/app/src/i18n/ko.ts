export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Cowork에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 Cowork 서버를 전환합니다.",
  ...
  "toast.update.description": "Cowork의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Cowork 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Cowork는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Cowork에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.row.language.description": "Cowork 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Cowork가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Cowork가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Cowork 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Cowork를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Cowork를 사용 중입니다.",
  ...
  "settings.general.row.developerMode.title": "개발자 모드",
  "settings.general.row.developerMode.description": "코드 중심 세부 정보 표시: 파일 차이, 변경 사항 탭, 터미널, 도구의 원래 이름",
  "welcome.title": "Cowork에 오신 것을 환영합니다",
  "welcome.subtitle": "Cowork는 선택한 폴더의 파일을 읽고, 쓰고, 정리해서 완성된 문서를 돌려드립니다. 시작하기 전에 두 가지만 하면 됩니다.",
  "welcome.folder.title": "작업할 폴더 선택",
  "welcome.folder.description": "작업하려는 파일이 들어 있는 폴더를 선택하세요. Cowork는 그 안에 있는 것만 다루며, 완성한 결과는 그 안의 'Deliverables' 폴더에 넣습니다. 폴더는 나중에 더 추가할 수 있습니다.",
  "welcome.folder.action": "폴더 선택",
  "welcome.folder.actionAgain": "다른 폴더 선택",
  "welcome.provider.title": "AI 서비스 연결",
  "welcome.provider.description": "Cowork가 생각하려면 AI 서비스 계정이 필요합니다. 로그인하거나 이미 사용 중인 서비스의 키를 붙여넣으세요. 키는 이 컴퓨터에만 저장됩니다.",
  "welcome.provider.action": "서비스 연결",
  "welcome.provider.actionAgain": "다른 서비스 연결",
  "welcome.provider.connected": "{{names}}에 연결됨",
  "welcome.start": "작업 시작",
  "welcome.start.blocked": "계속하려면 위의 두 단계를 모두 완료하세요",
