export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Cowork.",
  ...
  "dialog.server.description": "Przełącz serwer Cowork, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Cowork ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Cowork",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Cowork nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Cowork zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Cowork",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Cowork na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Cowork ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Cowork.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Cowork",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Cowork.",
  ...
  "settings.general.row.developerMode.title": "Tryb programisty",
  "settings.general.row.developerMode.description": "Pokaż szczegóły techniczne: różnice w plikach, kartę zmian, terminal i surowe nazwy narzędzi",
  "welcome.title": "Witamy w Cowork",
  "welcome.subtitle": "Cowork czyta, pisze i porządkuje pliki w wybranym przez Ciebie folderze i oddaje gotowe dokumenty. Dwie szybkie rzeczy, zanim zaczniesz.",
  "welcome.folder.title": "Wybierz folder do pracy",
  "welcome.folder.description": "Wybierz folder z plikami, nad którymi chcesz pracować. Cowork rusza tylko to, co jest w środku, a gotowe rzeczy odkłada do folderu „Deliverables”. Kolejne foldery dodasz później.",
  "welcome.folder.action": "Wybierz folder",
  "welcome.folder.actionAgain": "Wybierz inny folder",
  "welcome.provider.title": "Podłącz usługę AI",
  "welcome.provider.description": "Cowork potrzebuje konta w usłudze AI, żeby myśleć. Zaloguj się albo wklej klucz usługi, za którą już płacisz. Zostaje na tym komputerze i nigdzie indziej.",
  "welcome.provider.action": "Podłącz usługę",
  "welcome.provider.actionAgain": "Podłącz inną usługę",
  "welcome.provider.connected": "Połączono z {{names}}",
  "welcome.start": "Zacznij pracę",
  "welcome.start.blocked": "Ukończ oba kroki powyżej, aby kontynuować",

  "dialog.provider.custom.label": "Własny dostawca zgodny z OpenAI",
  ...
  "task.templates.heading": "Albo zacznij od jednego z tych",
  "task.template.summarize.title": "Podsumuj pliki",
  "task.template.summarize.prompt": "Przeczytaj pliki w tym obszarze roboczym i napisz mi raport podsumowujący.",
  "task.template.spreadsheet.title": "Zbuduj arkusz",
  "task.template.spreadsheet.prompt": "Wyciągnij liczby z tych plików i zbuduj mi arkusz, który mogę sortować i filtrować.",
  "task.template.report.title": "Napisz raport",
  "task.template.report.prompt": "Napisz raport na podstawie zawartości tego obszaru roboczego. Najpierw zapytaj mnie o to, czego potrzebujesz.",
  "task.template.organize.title": "Uporządkuj ten folder",
  "task.template.organize.prompt": "Uporządkuj ten folder w sensowne podfoldery i nadaj plikom jasne nazwy. Powiedz mi układ, zanim cokolwiek przeniesiesz.",
  "task.template.research.title": "Zbadaj temat",
  "task.template.research.prompt": "Zbadaj ten temat i opisz, co znajdziesz, wraz ze źródłami: ",
