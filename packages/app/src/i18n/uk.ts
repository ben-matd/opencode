export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Cowork.",
  ...
  "dialog.server.description": "Перемкніть сервер Cowork, до якого підключається ця програма.",
  ...
  "toast.update.description": "Нова версія Cowork ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Cowork",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Cowork ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cowork містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Cowork",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Cowork на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Cowork використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Cowork.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Cowork",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Cowork.",
  ...
  "settings.general.row.developerMode.title": "Режим розробника",
  "settings.general.row.developerMode.description": "Показувати технічні подробиці: відмінності файлів, вкладку змін, термінал і внутрішні назви інструментів",
  "welcome.title": "Вітаємо у Cowork",
  "welcome.subtitle": "Cowork читає, пише та впорядковує файли в обраній вами теці й повертає готові документи. Два швидкі кроки перед початком.",
  "welcome.folder.title": "Оберіть теку для роботи",
  "welcome.folder.description": "Оберіть теку з файлами, над якими хочете працювати. Cowork торкається лише того, що всередині, а готове складає в теку «Deliverables». Інші теки можна додати пізніше.",
  "welcome.folder.action": "Обрати теку",
  "welcome.folder.actionAgain": "Обрати іншу теку",
  "welcome.provider.title": "Підключіть сервіс ШІ",
  "welcome.provider.description": "Щоб думати, Cowork потрібен обліковий запис у сервісі ШІ. Увійдіть або вставте ключ сервісу, яким ви вже користуєтесь. Він залишиться на цьому комп'ютері.",
  "welcome.provider.action": "Підключити сервіс",
  "welcome.provider.actionAgain": "Підключити інший сервіс",
  "welcome.provider.connected": "Підключено до {{names}}",
  "welcome.start": "Почати роботу",
  "welcome.start.blocked": "Завершіть обидва кроки вище, щоб продовжити",
  ...
  "error.plain.apiKey": "Сервіс ШІ не прийняв ваш ключ. Відкрийте налаштування й підключіть сервіс заново.",
  "error.plain.rateLimit": "Сервіс ШІ просить збавити темп. Зачекайте хвилину й спробуйте ще раз.",
  "error.plain.quota": "На вашому рахунку в сервісі ШІ зараз немає коштів.",
  "error.plain.offline": "Не вдалося зв'язатися із сервісом ШІ. Перевірте підключення до інтернету й спробуйте ще раз.",
  "error.plain.folderMissing": "Цієї теки більше немає. Можливо, її перемістили, перейменували або видалили.",
  "error.plain.permissionDenied": "Cowork не має прав відкрити цей файл або теку на цьому комп'ютері.",
  "error.plain.noProvider": "Жоден сервіс ШІ ще не підключено. Відкрийте налаштування, щоб підключити.",
}
