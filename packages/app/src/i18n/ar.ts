export const dict = {
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Cowork.",
  ...
  "dialog.server.description": "تبديل خادم Cowork الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Cowork ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Cowork",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Cowork لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Cowork نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Cowork",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Cowork على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Cowork يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Cowork.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Cowork",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Cowork.",
  ...
  "settings.general.row.developerMode.title": "وضع المطوّر",
  "settings.general.row.developerMode.description": "إظهار التفاصيل التقنية: فروق الملفات، تبويب التغييرات، الطرفية، وأسماء الأدوات الخام",
  "welcome.title": "مرحبًا بك في Cowork",
  "welcome.subtitle": "يقرأ Cowork ملفات مجلد تختاره ويكتب فيها وينظّمها، ثم يعيد إليك مستندات جاهزة. خطوتان سريعتان قبل البدء.",
  "welcome.folder.title": "اختر مجلدًا للعمل فيه",
  "welcome.folder.description": "اختر المجلد الذي يحتوي الملفات التي تريد العمل عليها. لا يمسّ Cowork سوى ما بداخله، ويضع ما ينجزه في مجلد «Deliverables». يمكنك إضافة مجلدات أخرى لاحقًا.",
  "welcome.folder.action": "اختر مجلدًا",
  "welcome.folder.actionAgain": "اختر مجلدًا آخر",
  "welcome.provider.title": "اربط خدمة ذكاء اصطناعي",
  "welcome.provider.description": "يحتاج Cowork إلى حساب لدى خدمة ذكاء اصطناعي كي يفكّر. سجّل الدخول أو الصق مفتاح الخدمة التي تشترك بها بالفعل. يُحفظ على هذا الجهاز فقط.",
  "welcome.provider.action": "اربط خدمة",
  "welcome.provider.actionAgain": "اربط خدمة أخرى",
  "welcome.provider.connected": "متصل بـ {{names}}",
  "welcome.start": "ابدأ العمل",
  "welcome.start.blocked": "أكمل الخطوتين أعلاه للمتابعة",

  "dialog.provider.custom.label": "مزوّد مخصص متوافق مع OpenAI",
  "dialog.model.unpaid.viewMoreProviders": "استعرض أكثر من 70 مزوّدًا آخر",
  ...
  "error.plain.apiKey": "لم تقبل خدمة الذكاء الاصطناعي مفتاحك. افتح الإعدادات وأعد ربط الخدمة.",
  "error.plain.rateLimit": "تطلب خدمة الذكاء الاصطناعي التمهّل. انتظر دقيقة ثم أعد المحاولة.",
  "error.plain.quota": "لا يوجد رصيد حاليًا في حسابك لدى خدمة الذكاء الاصطناعي.",
  "error.plain.offline": "تعذّر الوصول إلى خدمة الذكاء الاصطناعي. تحقّق من اتصالك بالإنترنت وأعد المحاولة.",
  "error.plain.folderMissing": "لم يعد هذا المجلد موجودًا. ربما نُقل أو أُعيدت تسميته أو حُذف.",
  "error.plain.permissionDenied": "لا يُسمح لـ Cowork بفتح هذا الملف أو المجلد على هذا الجهاز.",
  "error.plain.noProvider": "لم تُربط أي خدمة ذكاء اصطناعي بعد. افتح الإعدادات لربط واحدة.",
}
