export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Cowork.",
  ...
  "dialog.server.description": "Переключите сервер Cowork к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Cowork ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Cowork",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Cowork пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Cowork включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Cowork",
  ...
  "settings.general.row.appearance.description": "Настройте как Cowork выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Cowork системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Cowork.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Cowork",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Cowork.",
  ...
  "settings.general.row.developerMode.title": "Режим разработчика",
  "settings.general.row.developerMode.description": "Показывать технические подробности: различия файлов, вкладку изменений, терминал и внутренние имена инструментов",
  "welcome.title": "Добро пожаловать в Cowork",
  "welcome.subtitle": "Cowork читает, пишет и упорядочивает файлы в выбранной вами папке и возвращает готовые документы. Два быстрых шага перед началом.",
  "welcome.folder.title": "Выберите папку для работы",
  "welcome.folder.description": "Выберите папку с файлами, с которыми хотите работать. Cowork трогает только то, что внутри неё, и складывает готовое в папку «Deliverables». Другие папки можно добавить позже.",
  "welcome.folder.action": "Выбрать папку",
  "welcome.folder.actionAgain": "Выбрать другую папку",
  "welcome.provider.title": "Подключите ИИ-сервис",
  "welcome.provider.description": "Чтобы думать, Cowork нужен аккаунт в ИИ-сервисе. Войдите или вставьте ключ сервиса, которым вы уже пользуетесь. Он останется на этом компьютере.",
  "welcome.provider.action": "Подключить сервис",
  "welcome.provider.actionAgain": "Подключить другой сервис",
  "welcome.provider.connected": "Подключено к {{names}}",
  "welcome.start": "Начать работу",
  "welcome.start.blocked": "Завершите оба шага выше, чтобы продолжить",
  ...
  "task.templates.heading": "Или начните с одного из этих",
  "task.template.summarize.title": "Собрать краткое изложение",
  "task.template.summarize.prompt": "Прочитай файлы в этом рабочем пространстве и напиши мне сводный отчёт.",
  "task.template.spreadsheet.title": "Собрать таблицу",
  "task.template.spreadsheet.prompt": "Извлеки цифры из этих файлов и собери таблицу, которую я смогу сортировать и фильтровать.",
  "task.template.report.title": "Набросать отчёт",
  "task.template.report.prompt": "Набросай отчёт по содержимому этого рабочего пространства. Сначала спроси всё, что тебе нужно знать.",
  "task.template.organize.title": "Разобрать папку",
  "task.template.organize.prompt": "Разбери эту папку по осмысленным подпапкам и дай файлам понятные имена. Скажи мне структуру, прежде чем что-то перемещать.",
  "task.template.research.title": "Изучить тему",
  "task.template.research.prompt": "Изучи эту тему и напиши, что нашёл, со ссылками на источники: ",

  "task.progress.working": "Работаю над этим",
  "task.progress.finishing": "Завершаю",
  "task.progress.steps": "Шаг {{done}} из {{total}}",

  "error.plain.apiKey": "ИИ-сервис не принял ваш ключ. Откройте настройки и подключите сервис заново.",
  "error.plain.rateLimit": "ИИ-сервис просит сбавить темп. Подождите минуту и попробуйте снова.",
  "error.plain.quota": "На вашем счёте в ИИ-сервисе сейчас нет средств.",
  "error.plain.offline": "Не удалось связаться с ИИ-сервисом. Проверьте подключение к интернету и попробуйте снова.",
  "error.plain.folderMissing": "Этой папки больше нет. Возможно, её переместили, переименовали или удалили.",
  "error.plain.permissionDenied": "У Cowork нет прав открыть этот файл или папку на этом компьютере.",
  "error.plain.noProvider": "Ни один ИИ-сервис ещё не подключён. Откройте настройки, чтобы подключить.",
}
