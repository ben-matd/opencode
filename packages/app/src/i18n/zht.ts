...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Cowork 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Cowork 伺服器。",
  ...
  "toast.update.description": "Cowork 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Cowork 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Cowork 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Cowork 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Cowork 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Cowork 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Cowork 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Cowork 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Cowork 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Cowork。",
  ...
  "settings.general.row.developerMode.title": "開發者模式",
  "settings.general.row.developerMode.description": "顯示面向程式碼的細節：檔案差異、變更分頁、終端機和工具原始名稱",
  "welcome.title": "歡迎使用 Cowork",
  "welcome.subtitle": "Cowork 會讀取、撰寫並整理你所選資料夾中的檔案，把做好的文件交回給你。開始前還有兩件小事。",
  "welcome.folder.title": "選擇一個工作資料夾",
  "welcome.folder.description": "選擇存放你要處理檔案的資料夾。Cowork 只會動其中的內容，並把完成的成果放進其中的「Deliverables」資料夾。之後還可以再新增資料夾。",
  "welcome.folder.action": "選擇資料夾",
  "welcome.folder.actionAgain": "換一個資料夾",
  "welcome.provider.title": "連接 AI 服務",
  "welcome.provider.description": "Cowork 需要一個 AI 服務帳號才能思考。登入，或貼上你已在使用的服務金鑰。金鑰只會保存在這台電腦上。",
  "welcome.provider.action": "連接服務",
  "welcome.provider.actionAgain": "連接其他服務",
  "welcome.provider.connected": "已連接到 {{names}}",
  "welcome.start": "開始工作",
  "welcome.start.blocked": "完成以上兩個步驟即可繼續",

  "dialog.provider.custom.label": "自訂 OpenAI 相容供應商",
  "dialog.model.unpaid.viewMoreProviders": "查看另外 70+ 家供應商",
