export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Cowork.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Cowork se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Cowork ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Cowork",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Cowork no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Cowork incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Cowork",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Cowork en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Cowork sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Cowork.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Cowork",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Cowork.",
  ...
  "settings.general.row.developerMode.title": "Modo desarrollador",
  "settings.general.row.developerMode.description": "Mostrar detalles orientados al código: diferencias de archivos, la pestaña de cambios, la terminal y los nombres internos de las herramientas",
  "welcome.title": "Bienvenido a Cowork",
  "welcome.subtitle": "Cowork lee, escribe y organiza los archivos de una carpeta que elijas, y te devuelve documentos terminados. Dos cosas rápidas antes de empezar.",
  "welcome.folder.title": "Elige una carpeta para trabajar",
  "welcome.folder.description": "Elige la carpeta con los archivos en los que quieres trabajar. Cowork solo toca lo que hay dentro y guarda lo que termina en una carpeta «Deliverables». Podrás añadir más carpetas después.",
  "welcome.folder.action": "Elegir una carpeta",
  "welcome.folder.actionAgain": "Elegir otra carpeta",
  "welcome.provider.title": "Conecta un servicio de IA",
  "welcome.provider.description": "Cowork necesita una cuenta en un servicio de IA para pensar. Inicia sesión o pega una clave del servicio que ya pagas. Se guarda en este ordenador y en ningún otro sitio.",
  "welcome.provider.action": "Conectar un servicio",
  "welcome.provider.actionAgain": "Conectar otro servicio",
  "welcome.provider.connected": "Conectado a {{names}}",
  "welcome.start": "Empezar a trabajar",
  "welcome.start.blocked": "Completa los dos pasos de arriba para continuar",
  ...
  "task.templates.heading": "O empieza con una de estas",
  "task.template.summarize.title": "Resumir archivos",
  "task.template.summarize.prompt": "Lee los archivos de este espacio de trabajo y escríbeme un informe resumen de lo que dicen.",
  "task.template.spreadsheet.title": "Crear una hoja de cálculo",
  "task.template.spreadsheet.prompt": "Extrae las cifras de estos archivos y créame una hoja de cálculo que pueda ordenar y filtrar.",
  "task.template.report.title": "Redactar un informe",
  "task.template.report.prompt": "Redacta un informe a partir de lo que hay en este espacio de trabajo. Pregúntame antes lo que necesites saber.",
  "task.template.organize.title": "Organizar esta carpeta",
  "task.template.organize.prompt": "Organiza esta carpeta en subcarpetas con sentido y ponles nombres claros a los archivos. Dime cómo quedará antes de mover nada.",
  "task.template.research.title": "Investigar un tema",
  "task.template.research.prompt": "Investiga este tema y escribe lo que encuentres, con fuentes: ",

  "task.progress.working": "Trabajando en ello",
  "task.progress.finishing": "Terminando",
  "task.progress.steps": "Paso {{done}} de {{total}}",

  "error.plain.apiKey": "El servicio de IA no aceptó tu clave. Abre Ajustes y vuelve a conectar el servicio.",
  "error.plain.rateLimit": "El servicio de IA pide que vayamos más despacio. Espera un minuto e inténtalo de nuevo.",
  "error.plain.quota": "Tu cuenta del servicio de IA se ha quedado sin saldo por ahora.",
  "error.plain.offline": "No se pudo contactar con el servicio de IA. Comprueba tu conexión a internet e inténtalo de nuevo.",
  "error.plain.folderMissing": "Esa carpeta ya no está. Puede que la hayan movido, renombrado o eliminado.",
  "error.plain.permissionDenied": "Cowork no tiene permiso para abrir ese archivo o carpeta en este ordenador.",
  "error.plain.noProvider": "Todavía no hay ningún servicio de IA conectado. Abre Ajustes para conectar uno.",
}
