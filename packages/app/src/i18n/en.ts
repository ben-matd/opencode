export const dict = {
  ...
  "command.category.project": "Workspace",
  ...
  "command.category.workspace": "Branch copies",
  ...
  "command.project.open": "Open workspace",
  "command.project.previous": "Previous workspace",
  "command.project.next": "Next workspace",
  "command.project.index": "Switch to workspace {{index}}",
  ...
  "command.workspace.toggle": "Toggle branch copies",
  "command.workspace.toggle.description": "Enable or disable multiple branch copies in the sidebar",
  ...
  "command.session.compact": "Shorten conversation",
  "command.session.compact.description": "Summarize the conversation so far to free up room",
  "command.session.fork": "Fork from message",
  "command.session.fork.description": "Create a new conversation from a previous message",
  "command.session.share": "Share conversation",
  "command.session.share.description": "Share this conversation and copy the URL to clipboard",
  "command.session.unshare": "Unshare conversation",
  "command.session.unshare.description": "Stop sharing this conversation",

  "palette.search.placeholder": "Search files, commands, and conversations",
  "palette.search.placeholder.home": "Search commands and conversations",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Cowork.",
  ...
  "session.child.promptDisabled": "Helper conversations can't be replied to.",
  "session.child.backToParent": "Back to the main conversation.",

  "prompt.example.1": "Summarize these files into a report",
  "prompt.example.2": "What is in this workspace?",
  "prompt.example.3": "Turn this data into a spreadsheet",
  "prompt.example.4": "Draft a one-page brief on...",
  "prompt.example.5": "Organize this folder by date",
  "prompt.example.6": "Pull the key figures out of these PDFs",
  "prompt.example.7": "Rewrite this to be clearer and shorter",
  "prompt.example.8": "Compare these two documents",
  "prompt.example.9": "Find every mention of... across these files",
  "prompt.example.10": "Write meeting notes from this transcript",
  "prompt.example.11": "Build a budget spreadsheet from these receipts",
  "prompt.example.12": "Proofread this document",
  "prompt.example.13": "Make an outline for a presentation on...",
  "prompt.example.14": "Research this topic and write it up",
  "prompt.example.15": "Check these numbers against the source",
  "prompt.example.16": "Combine these spreadsheets into one",
  "prompt.example.17": "Give me a plain-language summary of this contract",
  "prompt.example.18": "Convert these files to PDF",
  "prompt.example.19": "Rename these files to a consistent pattern",
  "prompt.example.20": "What changed between these two versions?",
  "prompt.example.21": "Write an email summarizing this",
  "prompt.example.22": "Pull out every action item from these notes",
  "prompt.example.23": "Make a timeline of what happened",
  "prompt.example.24": "Draft a proposal based on these documents",
  "prompt.example.25": "Sort these photos into folders",
  ...
  "prompt.toast.worktreeCreateFailed.title": "Couldn't create the branch copy",
  "prompt.toast.sessionCreateFailed.title": "Failed to create conversation",
  ...
  "prompt.toast.promptSendFailed.description": "Unable to retrieve conversation",
  ...
  "dialog.server.description": "Switch which Cowork server this app connects to.",
  ...
  "dialog.project.edit.icon.alt": "Workspace icon",
  ...
  "dialog.project.edit.worktree.startup": "Branch copy startup script",
  "dialog.project.edit.worktree.startup.description": "Runs after creating a new branch copy.",
  ...
  "context.stats.sessionCreated": "Conversation Created",
  ...
  "toast.workspace.enabled.title": "Branch copies enabled",
  "toast.workspace.enabled.description": "Multiple branch copies are now shown in the sidebar",
  "toast.workspace.disabled.title": "Branch copies disabled",
  "toast.workspace.disabled.description": "Only the main branch copy is shown in the sidebar",
  ...
  "toast.model.none.description": "Connect a provider to summarize this conversation",
  ...
  "toast.session.share.failed.title": "Failed to share conversation",
  "toast.session.share.failed.description": "An error occurred while sharing the conversation",

  "toast.session.unshare.success.title": "Conversation unshared",
  "toast.session.unshare.success.description": "Conversation unshared successfully!",
  "toast.session.unshare.failed.title": "Failed to unshare conversation",
  "toast.session.unshare.failed.description": "An error occurred while unsharing the conversation",

  "toast.session.listFailed.title": "Couldn't load conversations for {{project}}",
  "toast.project.reloadFailed.title": "Couldn't reload {{project}}",

  "toast.update.title": "Update available",
  "toast.update.description": "A new version of Cowork ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Cowork team",
  ...
  "error.childStore.persistedProjectMetadataCreateFailed": "Couldn't save workspace details",
  "error.childStore.persistedProjectIconCreateFailed": "Couldn't save the workspace icon",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Cowork does not support MCP authentication yet.',
  ...
  "home.server.collapse": "Collapse server workspaces",
  "home.server.expand": "Expand server workspaces",
  "home.sessions.search.placeholder": "Search conversations",
  "home.sessions.search.placeholder.scoped": "Search conversations in {{scope}}",
  "home.sessions.search.sessions": "Conversations",
  "home.sessions.search.noResults": "No conversations found for {{query}}",
  "home.sessions.empty": "Nothing here yet",
  "home.sessions.empty.description": "Create a conversation to get started",
  ...
  "session.tab.unknown": "Unknown Conversation",
  "session.panel.reviewAndFiles": "Review and files",
  "session.error.notFound": "This conversation cannot be found",
  "session.error.notFound.description": "This tab points to a conversation that no longer exists on this server.",
  ...
  "session.review.noVcs.createGit.description": "Track, review, and undo changes in this workspace",
  ...
  "session.review.noSnapshot": "Change tracking is turned off, so changes from this conversation aren't available",
  ...
  "session.new.project.new": "New workspace",
  "session.new.project.search": "Search workspaces",
  "session.new.project.add": "Add workspace",
  "session.new.worktree.main": "Main branch",
  "session.new.worktree.mainWithBranch": "Main branch ({{branch}})",
  "session.new.worktree.create": "Create new branch copy",
  "session.new.workspace.runIn": "Run in",
  "session.new.workspace.triggerLocal": "Local",
  "session.new.workspace.local": "This workspace",
  "session.new.workspace.existing": "Branch copy…",
  ...
  "sidebar.nav.projectsAndSessions": "Workspaces and conversations",
  "sidebar.settings": "Settings",
  "sidebar.help": "Help",
  "sidebar.workspaces.enable": "Enable branch copies",
  "sidebar.workspaces.disable": "Disable branch copies",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "Cowork includes free models so you can start immediately.",
  ...
  "sidebar.empty.title": "No workspaces open",
  "sidebar.empty.description": "Choose a folder to work in to get started",
  ...
  "app.name.desktop": "Cowork Desktop",
  ...
  "settings.general.row.language.description": "Change the display language for Cowork",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Cowork looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Cowork follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Cowork is themed.",
  ...
  "settings.general.row.showFileTree.description": "Show the file tree panel in conversations",
  ...
  "settings.general.row.developerMode.description":
    "Show code-oriented details: file diffs, the changes tab, the terminal, and raw tool names",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Cowork launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Cowork.",
  ...
  "settings.permissions.tool.external_directory.description": "Access files outside the workspace folder",
  "settings.permissions.tool.doom_loop.title": "Doom Loop",
  "settings.permissions.tool.doom_loop.description": "Detect repeated tool calls with identical input",

  "session.delete.failed.title": "Failed to delete conversation",
  ...
  "workspace.new": "New branch copy",
  "workspace.type.local": "local",
  "workspace.type.sandbox": "sandbox",
  "workspace.create.failed.title": "Couldn't create the branch copy",
  "workspace.delete.failed.title": "Couldn't delete the branch copy",
  "workspace.resetting.title": "Resetting branch copy",
  "workspace.resetting.description": "This may take a minute.",
  "workspace.reset.failed.title": "Couldn't reset the branch copy",
  "workspace.reset.success.title": "Branch copy reset",
  "workspace.reset.success.description": "The branch copy now matches the default branch.",
  "workspace.error.stillPreparing": "The branch copy is still being prepared",
  ...
  "workspace.status.dirty": "Unmerged changes detected in this branch copy.",
  "workspace.delete.title": "Delete branch copy",
  "workspace.delete.confirm": 'Delete branch copy "{{name}}"?',
  "workspace.delete.button": "Delete branch copy",
  "workspace.reset.title": "Reset branch copy",
  "workspace.reset.confirm": 'Reset branch copy "{{name}}"?',
  "workspace.reset.button": "Reset branch copy",
