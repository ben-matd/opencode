export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Cowork-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Cowork server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Cowork-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Cowork timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Cowork još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Cowork uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Cowork-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Cowork izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Cowork prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Cowork-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Cowork pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Cowork-a.",
  ...
  "settings.general.row.developerMode.title": "Razvojni način",
  "settings.general.row.developerMode.description": "Prikaži detalje namijenjene programerima: razlike u datotekama, karticu s izmjenama, terminal i sirove nazive alata",
  "welcome.title": "Dobro došli u Cowork",
  "welcome.subtitle": "Cowork čita, piše i uređuje datoteke u mapi koju odaberete i vraća vam gotove dokumente. Dvije brze stvari prije početka.",
  "welcome.folder.title": "Odaberite mapu za rad",
  "welcome.folder.description": "Odaberite mapu s datotekama na kojima želite raditi. Cowork dira samo ono što je u njoj, a gotovo sprema u mapu „Deliverables“. Više mapa možete dodati kasnije.",
  "welcome.folder.action": "Odaberi mapu",
  "welcome.folder.actionAgain": "Odaberi drugu mapu",
  "welcome.provider.title": "Povežite AI uslugu",
  "welcome.provider.description": "Coworku treba račun kod AI usluge da bi mogao razmišljati. Prijavite se ili zalijepite ključ usluge koju već plaćate. Ostaje na ovom računaru i nigdje drugdje.",
  "welcome.provider.action": "Poveži uslugu",
  "welcome.provider.actionAgain": "Poveži drugu uslugu",
  "welcome.provider.connected": "Povezano s {{names}}",
  "welcome.start": "Počni raditi",
  "welcome.start.blocked": "Dovršite oba koraka iznad da nastavite",
