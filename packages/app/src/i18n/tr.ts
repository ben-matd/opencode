...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Cowork'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Cowork sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Cowork'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Cowork ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Cowork henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Cowork ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Cowork Masaüstü",
  ...
  "settings.general.row.language.description": "Cowork'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Cowork'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Cowork'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Cowork'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Cowork başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Cowork'un en son sürümünü kullanıyorsunuz.",
  ...
  "settings.general.row.developerMode.title": "Geliştirici modu",
  "settings.general.row.developerMode.description": "Koda dönük ayrıntıları göster: dosya farkları, değişiklikler sekmesi, terminal ve ham araç adları",
  "welcome.title": "Cowork'e hoş geldiniz",
  "welcome.subtitle": "Cowork seçtiğiniz bir klasördeki dosyaları okur, yazar ve düzenler; size bitmiş belgeler verir. Başlamadan önce iki kısa adım.",
  "welcome.folder.title": "Çalışacağınız klasörü seçin",
  "welcome.folder.description": "Üzerinde çalışmak istediğiniz dosyaların bulunduğu klasörü seçin. Cowork yalnızca içindekilere dokunur ve bitirdiklerini oradaki “Deliverables” klasörüne koyar. Sonradan başka klasörler de ekleyebilirsiniz.",
  "welcome.folder.action": "Klasör seç",
  "welcome.folder.actionAgain": "Başka bir klasör seç",
  "welcome.provider.title": "Bir yapay zekâ servisi bağlayın",
  "welcome.provider.description": "Cowork'ün düşünebilmesi için bir yapay zekâ servisinde hesap gerekir. Giriş yapın ya da zaten kullandığınız servisin anahtarını yapıştırın. Anahtar yalnızca bu bilgisayarda saklanır.",
  "welcome.provider.action": "Servis bağla",
  "welcome.provider.actionAgain": "Başka bir servis bağla",
  "welcome.provider.connected": "{{names}} bağlandı",
  "welcome.start": "Çalışmaya başla",
  "welcome.start.blocked": "Devam etmek için yukarıdaki iki adımı tamamlayın",
