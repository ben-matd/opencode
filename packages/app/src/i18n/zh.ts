...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Cowork 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Cowork 服务器。",
  ...
  "toast.update.description": "Cowork 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Cowork 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Cowork 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Cowork 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Cowork 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Cowork 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Cowork 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Cowork 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Cowork 启动时自动检查更新",
  ...
  "settings.general.row.developerMode.title": "开发者模式",
  "settings.general.row.developerMode.description": "显示面向代码的细节：文件差异、更改标签页、终端和工具原始名称",
  "welcome.title": "欢迎使用 Cowork",
  "welcome.subtitle": "Cowork 会读取、撰写并整理你所选文件夹中的文件，把做好的文档交回给你。开始前还有两件小事。",
  "welcome.folder.title": "选择一个工作文件夹",
  "welcome.folder.description": "选择存放你要处理的文件的文件夹。Cowork 只会动其中的内容，并把完成的成果放进其中的“Deliverables”文件夹。之后还可以再添加文件夹。",
  "welcome.folder.action": "选择文件夹",
  "welcome.folder.actionAgain": "换一个文件夹",
  "welcome.provider.title": "连接 AI 服务",
  "welcome.provider.description": "Cowork 需要一个 AI 服务账号才能思考。登录，或粘贴你已在使用的服务的密钥。密钥只保存在这台电脑上。",
  "welcome.provider.action": "连接服务",
  "welcome.provider.actionAgain": "连接其他服务",
  "welcome.provider.connected": "已连接到 {{names}}",
  "welcome.start": "开始工作",
  "welcome.start.blocked": "完成以上两步后即可继续",
