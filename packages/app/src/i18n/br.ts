export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Cowork.",
  ...
  "dialog.server.description": "Trocar para qual servidor Cowork este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Cowork ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Cowork",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Cowork ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cowork inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Cowork",
  ...
  "settings.general.row.appearance.description": "Personalize como o Cowork aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Cowork segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Cowork é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Cowork iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Cowork.",
  ...
  "settings.general.row.developerMode.title": "Modo desenvolvedor",
  "settings.general.row.developerMode.description": "Mostrar detalhes voltados a código: diferenças de arquivos, a aba de alterações, o terminal e os nomes brutos das ferramentas",
  "welcome.title": "Bem-vindo ao Cowork",
  "welcome.subtitle": "O Cowork lê, escreve e organiza os arquivos de uma pasta que você escolher, e devolve documentos prontos. Duas coisas rápidas antes de começar.",
  "welcome.folder.title": "Escolha uma pasta para trabalhar",
  "welcome.folder.description": "Escolha a pasta com os arquivos em que você quer trabalhar. O Cowork só mexe no que está dentro dela e guarda o que termina numa pasta “Deliverables”. Você pode adicionar mais pastas depois.",
  "welcome.folder.action": "Escolher uma pasta",
  "welcome.folder.actionAgain": "Escolher outra pasta",
  "welcome.provider.title": "Conecte um serviço de IA",
  "welcome.provider.description": "O Cowork precisa de uma conta em um serviço de IA para pensar. Faça login ou cole uma chave do serviço que você já paga. Ela fica neste computador e em nenhum outro lugar.",
  "welcome.provider.action": "Conectar um serviço",
  "welcome.provider.actionAgain": "Conectar outro serviço",
  "welcome.provider.connected": "Conectado a {{names}}",
  "welcome.start": "Começar a trabalhar",
  "welcome.start.blocked": "Conclua os dois passos acima para continuar",
