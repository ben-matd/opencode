export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Cowork.",
  ...
  "dialog.server.description": "Changez le serveur Cowork auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Cowork ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Cowork",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Cowork ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Cowork inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Cowork",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Cowork sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Cowork suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Cowork.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Cowork",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Cowork.",
  ...
  "settings.general.row.developerMode.title": "Mode développeur",
  "settings.general.row.developerMode.description": "Afficher les détails orientés code : différences de fichiers, l'onglet des modifications, le terminal et les noms bruts des outils",
  "welcome.title": "Bienvenue dans Cowork",
  "welcome.subtitle": "Cowork lit, écrit et organise les fichiers d'un dossier que vous choisissez, et vous rend des documents terminés. Deux choses rapides avant de commencer.",
  "welcome.folder.title": "Choisissez un dossier de travail",
  "welcome.folder.description": "Choisissez le dossier contenant les fichiers sur lesquels vous voulez travailler. Cowork ne touche qu'à ce qui s'y trouve et range ce qu'il termine dans un dossier « Deliverables ». Vous pourrez en ajouter d'autres plus tard.",
  "welcome.folder.action": "Choisir un dossier",
  "welcome.folder.actionAgain": "Choisir un autre dossier",
  "welcome.provider.title": "Connectez un service d'IA",
  "welcome.provider.description": "Cowork a besoin d'un compte auprès d'un service d'IA pour réfléchir. Connectez-vous, ou collez une clé du service que vous payez déjà. Elle reste sur cet ordinateur.",
  "welcome.provider.action": "Connecter un service",
  "welcome.provider.actionAgain": "Connecter un autre service",
  "welcome.provider.connected": "Connecté à {{names}}",
  "welcome.start": "Commencer à travailler",
  "welcome.start.blocked": "Terminez les deux étapes ci-dessus pour continuer",
  ...
  "task.templates.heading": "Ou commencez par ceci",
  "task.template.summarize.title": "Résumer des fichiers",
  "task.template.summarize.prompt": "Lis les fichiers de cet espace de travail et rédige-moi un rapport de synthèse.",
  "task.template.spreadsheet.title": "Créer un tableur",
  "task.template.spreadsheet.prompt": "Extrais les chiffres de ces fichiers et crée-moi un tableur que je peux trier et filtrer.",
  "task.template.report.title": "Rédiger un rapport",
  "task.template.report.prompt": "Rédige un rapport à partir du contenu de cet espace de travail. Demande-moi d'abord ce que tu dois savoir.",
  "task.template.organize.title": "Ranger ce dossier",
  "task.template.organize.prompt": "Range ce dossier en sous-dossiers cohérents et donne aux fichiers des noms clairs. Dis-moi la structure prévue avant de déplacer quoi que ce soit.",
  "task.template.research.title": "Faire une recherche",
  "task.template.research.prompt": "Fais une recherche sur ce sujet et rédige ce que tu trouves, avec les sources : ",
