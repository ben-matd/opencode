export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Cowork.",
  ...
  "dialog.server.description": "Skift hvilken Cowork-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Cowork ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Cowork-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Cowork understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Cowork inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Cowork",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Cowork ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Cowork følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Cowork er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Cowork starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Cowork.",
  ...
  "settings.general.row.developerMode.title": "Udviklertilstand",
  "settings.general.row.developerMode.description": "Vis kodeorienterede detaljer: filforskelle, fanen med ændringer, terminalen og rå værktøjsnavne",
  "welcome.title": "Velkommen til Cowork",
  "welcome.subtitle": "Cowork læser, skriver og organiserer filerne i en mappe, du vælger, og giver dig færdige dokumenter tilbage. To hurtige ting, før du går i gang.",
  "welcome.folder.title": "Vælg en mappe at arbejde i",
  "welcome.folder.description": "Vælg mappen med de filer, du vil arbejde med. Cowork rører kun ved det, der ligger i den, og lægger det færdige i en mappe ved navn “Deliverables”. Du kan tilføje flere mapper senere.",
  "welcome.folder.action": "Vælg en mappe",
  "welcome.folder.actionAgain": "Vælg en anden mappe",
  "welcome.provider.title": "Forbind en AI-tjeneste",
  "welcome.provider.description": "Cowork skal bruge en konto hos en AI-tjeneste for at kunne tænke. Log ind, eller indsæt en nøgle fra den tjeneste, du allerede betaler for. Den bliver på denne computer.",
  "welcome.provider.action": "Forbind en tjeneste",
  "welcome.provider.actionAgain": "Forbind en anden tjeneste",
  "welcome.provider.connected": "Forbundet til {{names}}",
  "welcome.start": "Kom i gang",
  "welcome.start.blocked": "Fuldfør begge trin ovenfor for at fortsætte",
