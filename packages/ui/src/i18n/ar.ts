export const dict = {
  ...
  "ui.messagePart.title.write": "إنشاء",
  ...
  "ui.tool.list": "بحث داخل",
  "ui.tool.glob": "بحث عن",
  "ui.tool.grep": "بحث عن",
  "ui.tool.webfetch": "قراءة الصفحة",
  "ui.tool.websearch": "بحث في الويب",
  "ui.tool.shell": "Shell",
  "ui.tool.patch": "تحرير",
  "ui.tool.todos": "تخطيط",
  "ui.tool.todos.read": "مراجعة الخطة",
  "ui.tool.questions": "سؤال لك",
  ...
  "ui.tool.write.update": "تحديث",
  "ui.tool.shell.folder": "إنشاء مجلد",
  "ui.tool.shell.move": "نقل الملفات",
  "ui.tool.shell.copy": "نسخ الملفات",
  "ui.tool.shell.delete": "حذف الملفات",
