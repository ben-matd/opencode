export const dict: Record<string, string> = {
  ...
  "ui.messagePart.title.write": "Створення",
  ...
  "ui.tool.list": "Перегляд у",
  "ui.tool.glob": "Пошук",
  "ui.tool.grep": "Пошук за текстом",
  "ui.tool.task": "Завдання",
  "ui.tool.webfetch": "Читання сторінки",
  "ui.tool.websearch": "Пошук в інтернеті",
  "ui.tool.shell": "Оболонка",
  "ui.tool.patch": "Редагування",
  "ui.tool.todos": "Планування",
  "ui.tool.todos.read": "Перевірка плану",
  "ui.tool.questions": "Запитання до вас",
  "ui.tool.agent": "Агент {{type}}",
  "ui.tool.agent.default": "Агент",
  "ui.tool.skill": "Використання навички",
  ...
  "ui.tool.write.update": "Оновлення",
  "ui.tool.shell.folder": "Створення теки",
  "ui.tool.shell.move": "Переміщення файлів",
  "ui.tool.shell.copy": "Копіювання файлів",
  "ui.tool.shell.delete": "Видалення файлів",
