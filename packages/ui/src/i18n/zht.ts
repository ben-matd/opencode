...
export const dict = {
  ...
  "ui.messagePart.title.edit": "正在編輯",
  "ui.messagePart.title.write": "正在建立",
  ...
  "ui.tool.glob": "正在尋找",
  "ui.tool.grep": "正在搜尋",
  "ui.tool.webfetch": "正在閱讀網頁",
  "ui.tool.websearch": "正在搜尋網路",
  "ui.tool.shell": "Shell",
  "ui.tool.patch": "正在編輯",
  "ui.tool.todos": "正在規劃",
  "ui.tool.todos.read": "正在核對計畫",
  "ui.tool.questions": "正在詢問你",
  ...
  "ui.tool.shell.folder": "正在建立資料夾",
  "ui.tool.shell.move": "正在移動檔案",
  "ui.tool.shell.copy": "正在複製檔案",
  "ui.tool.shell.delete": "正在刪除檔案",
