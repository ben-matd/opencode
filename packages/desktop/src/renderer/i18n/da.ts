export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Cowork",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Cowork er blevet downloadet. Vil du installere den og genstarte?",
