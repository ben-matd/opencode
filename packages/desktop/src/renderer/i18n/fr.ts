export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Cowork",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Cowork a été téléchargée. Voulez-vous l'installer et redémarrer ?",
