export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Cowork",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Cowork wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
