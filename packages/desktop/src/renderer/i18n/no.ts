export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Cowork",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Cowork er lastet ned. Vil du installere den og starte på nytt?",
