export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Cowork-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Cowork-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
